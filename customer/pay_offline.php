...
<div class="table-responsive"><!--  table-responsive Begin  -->
    ...
    <table class="table table-bordered table-hover table-striped"><!--  table table-bordered table-hover Begin  -->
        ...
        <tbody><!--  tbody Begin  -->
        <td> Bank Name: Access Bank | Account No: 0032715060 </td>
        <td>Bank of America | Mobile No: +1 (757) 632-6371 | Name: Victor Nwala </td>
        <td>Name: Renaissance Assembly | Transfer Code: 00234 </td>
