...
<form action="" method="post" enctype="multipart/form-data"><!-- form begins -->
    ...
    <div class="form-group"><!-- form-group" begins -->
        ...
        <input type="tel" name="c_number" class="form-control" value="<?php echo $customer_contact; ?>" required>
    ...
    <div class="form-group form-height-custom"><!-- form-group" begins -->
